    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2><img class="mb-4" src="idcard.png" alt="" width="50" height="50">  회원정보 수정</h2>
          <form method="post" action="deleteTestPro.php">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="user_name" id="user_name" value="<? echo $name?>" placeholder="<? echo $name?>" maxlength="10" readonly>
            </div>

            <div class="mb-3">
              <label for="name" class="form-label">전화번호</label>
              <input type="text" class="form-control" name="user_number" id="user_number" value="<? echo $number?>" placeholder="<? echo $number?>" maxlength="10" readonly>
            </div>
