...
<body>
	...
	<div class="container-fluid">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <form method="post" action="ans.php?id=<?php echo $id; ?>">
                <a href="javascript:doDisplay();">> 답변쓰기</a><br>
                <div id="ans" style="display:none;">
                    <div class="input-group mb-3">
                        <textarea name="content" id="content" cols="150" rows="12" aria-describedby="button-addon2" required></textarea><br>
                        <input type="submit" class="btn btn-outline-secondary" id="button-addon2" value="작성완료">
                    </div>
                </div>
            </form>
		</main>
